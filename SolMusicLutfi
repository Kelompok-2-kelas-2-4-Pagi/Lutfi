			...
			<div class="hs-item">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="hr-img">
								<img src="img/4d736bb6-9c88-45ae-ba6c-3b1e5fdc236d_43.jpeg" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="concept-item">
						<img src="img/concept/5e5653813cd4e.jpeg" alt="">
						<h5>R&B Kontemporer Music</h5>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="concept-item">
						<img src="img/concept/00289347.jpg" alt="">
						<h5>Live Concerts</h5>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="concept-item">
						<img src="img/concept/0000045375.jpg" alt="">
						<h5>RFAS Clothing</h5>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="concept-item">
						<img src="img/concept/b7ee6f5f_Untitled design (7).jpg" alt="">
						<h5>Album Jejak</h5>
					</div>
				</div>
			</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
					<div class="social-links">
						<a href="https://www.instagram.com/rizkyfbian/"><i class="fa fa-instagram"></i></a>
						<a href="https://twitter.com/rizky_febian"><i class="fa fa-twitter"></i></a>
						<a href="https://open.spotify.com/artist/28DdkLhrzQNizZ0ExQpyku?si=B_vDHBDtRyaAVHhzNJQWQw"><i class="fa fa-spotify"></i></a>
						<a href="https://www.youtube.com/channel/UCbygpKn8gqj1LMTMyROF9fg"><i class="fa fa-youtube"></i></a>
					</div>
				</div>
			</div>
		</div>
